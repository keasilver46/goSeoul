...
function getParam(sname) {
 ...
 // 테스트 파라미터 포함 값은 > test.html?contId=2828431
      ...
      $.ajax({
        ...
        success: function(data) {
         ...
         //  받아온 dt.homepage값에서 순수 url만 추출하는 코드
            ...
            $("#address").html("<b>주소:  </b><br>" + $("<span>").text(dt.addr1).html());
            mapx = dt.mapx;
            mapy = dt.mapy;
      ...
      $.ajax({
          ...
          success: function(data2) {
            ...
            for (let i = 0; i < detail2.length; i++) {
              ...
              $("#eventplace").html("<b>행사장 정보:  </b><br>" + $("<span>").text(dt2.eventplace).html());
              $("#playtime").html("<b>이용 시간:  </b><br>" + $("<span>").text(dt2.playtime).html().replace(/<br>/g, "<br/>"));
              $("#usetimefestival").html("<b>입장료:  </b><br>" + $("<span>").text(dt2.usetimefestival).html().replace(/<br>/g, "<br/>"));
