                ...
                <h4 class="mb-3">회원가입</h4>
                    ...
                    <div class="mb-3">
                        <div id="posRelId">
                            ...
                            <input type="id" class="form-control" autofocus="autofocus" id="id"  name="id" placeholder="ID">
                            
                            <input type="button" id="dupbutid" value="중복검사" onClick="id_check()">
                        </div>
                        <div id="idcheck"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" id="pass2" name="pass2" placeholder="비밀번호확인">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div id="posRelNick">
                                <label for="nick">별명(닉네임)</label>
                                <input type="text" class="form-control" id="nick" name="nick" placeholder="닉네임">
                                
                                <input type="button" id="dupbutnick" value="중복검사" onClick="nick_check()">
                            </div>    
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" size="10" class="form-control" id="email" name="email" placeholder="이메일@">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" id="h1" name="interests" value="액티비티" checked>액티비티&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="checkbox" id="h2" name="interests" value="게임">게임&nbsp;&nbsp;&nbsp;&nbsp;
