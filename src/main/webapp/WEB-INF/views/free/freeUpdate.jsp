...
<body>
	<div class="wrap">
		...
		<br>
		<h4 class="mb-3" align="center">여행정보 수정</h4>
				...
				<div
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<select class="custom-select mr-sm-4" id="free_category"
								...
								<option value="정보공유"
									${freeBean.free_category == '정보공유' ? 'selected' : ''}>정보공유</option>
								<option value="여행후기"
									${freeBean.free_category == '여행후기' ? 'selected' : ''}>여행후기</option>
								<option value="질문"
									${freeBean.free_category == '질문' ? 'selected' : ''}>질문</option>
								<option value="기타"
									${freeBean.free_category == '기타' ? 'selected' : ''}>기타</option>
					...
					<div class="form-group">
						<input type="text" id="free_title" name="free_title"
							...
							value="${freeBean.free_title}" required>
					</div>

					<div class="form-group">
						<div class="form-group">
							<textarea id="free_content" name="free_content" rows="15"
								cols="50" class="form-control" placeholder="내용을 입력해주세요."
								required>${freeBean.free_content}</textarea>
						</div>
