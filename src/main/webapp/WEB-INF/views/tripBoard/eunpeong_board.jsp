...
.local {
	...
	height: 500px;
	object-fit: cover;
	object-position: left 0px bottom 50%;
	position: relative;
}
...
<body onLoad="eunpeong()">
	<c:import url="../header.jsp" />
	<div class="form-group image">
		<img class="local" id="main_img" src="images/eun.jpg">
	...
	<div class="container-fluid">
		<div class="menu">
			...
			<div id="trip_check" class="trip_check">
				<a href="javascript:" id="travel_id" onclick="travel1()">관광지</a>
				&nbsp; &nbsp; <a href="javascript:" id="culture_id"
					onclick="culture1()">문화시설</a> &nbsp; &nbsp; <a href="javascript:"
					id="leisusre_id" onclick="leisure1()">레포츠</a> &nbsp; &nbsp; <a
					href="javascript:" id="hotel_id" onclick="hotel1()">숙박시설</a> &nbsp;
				&nbsp; <a href="javascript:" id="shopping_id" onclick="shopping1()">쇼핑</a>
				&nbsp; &nbsp; <a href="javascript:" id="restaurant_id"
					onclick="restaurant1()">음식점</a>
			</div>
		...
		<!-- card 정보 들어갈 곳  -->
		<br> <a id="topBtn" href="#"><img id="topimg"
			src="images/arrow.png" style="max-width: 50px; max-height: 50px;"></a>
