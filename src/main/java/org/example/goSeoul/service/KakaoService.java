...
public class KakaoService {
    ...
    public String getAccessToken(String authorize_code) {
        ...
        // 토큰발급 요청을 보낼 주소, 카카오에 어떤 경로로 요청을 보낼 지 변수에 담기
        ...
        try {
            ...
            sb.append("&client_id=53907bf2cc99ddbb1929db25394e8fae");
            sb.append("&redirect_uri=http://localhost:8082/goSeoul/kakaoLogin.do");
    ...
    //회원정보 요청, 사용자 정보 보기
    public KakaoVo kakaoUserInfo(String access_Token) throws IOException {
        System.out.println("-------------------------사용자 정보 보기---------------------------");

        KakaoVo kakaoUserInfo = new KakaoVo();
