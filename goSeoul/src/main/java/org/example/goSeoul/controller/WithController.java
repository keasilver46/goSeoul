...
//        model.addAttribute("user",joinMemberBean);
	...
	public String withWriteResult(@ModelAttribute WithBean wb, @RequestParam("with_filename1") MultipartFile mf,
...
//        model.addAttribute("result", result);
	...
	public String with_reserve(@ModelAttribute ReserveBean rb, int with_no, int page, String state, HttpSession session,
	...
	public String with_reply(@ModelAttribute WithReplyBean wrb, int with_no, int page, String state,
